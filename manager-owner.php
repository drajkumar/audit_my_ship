									...
									<div class="single-table">
					                  ...
					                  $indntification = $user->getData_one_cul('indntification', 'uni_code', $uni_code);
										...
										?>
													...
													<thead class="text-uppercase" style="border:1px solid black; background-color:#A299FF"> 
													<th>            
														<b><h5 class="text-uppercase text-center">NAME</h5></b></th>
															<th>            
														<b><h5 class="text-uppercase text-center">ADDRESS</h5></b></th>
													</thead>
													<tr id="table-bordered">
													
														<td class="text-uppercase text-center"><h5>Registered owner</h5></td>
														<td style="border:1px solid black"></td>
														
													</tr>
													<tr>
														<td  style="border:1px solid black" class="left-td">Name.........</td>
														<td style="border:1px solid black" >ADDRESSSSSSSSSSSSSSSSSSSS</td>
													</tr>
															<tr>
													
														<td class="text-uppercase text-center"><h5>Manager</h5></td>
														<td style="border:1px solid black"></td>
													</tr>
													<tr>
														<td  style="border:1px solid black" class="left-td">Name........</td>
														<td style="border:1px solid black" style="border:1px solid black" >ADDRESSSSSSSSSSSSSSSSSSSS</td>
													</tr>		<tr >
													
														<td class="text-uppercase text-center"><h5>ISM Manager</h5></td>
														<td style="border:1px solid black"></td>
													</tr>
													<tr>
														<td style="border:1px solid black" class="left-td">Name.......</td>
