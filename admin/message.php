									...
									<div class="table-responsive">
										<table class="table text-center">
											...
											<tbody>
												 <?php
									                   $x = 0;
									                  $content = $admin->get_all('message', 'id');
													  ...
													  <div class="modal-dialog modal-dialog-centered" role="document">
													    <div class="modal-content">
													      ...
													      <div class="modal-footer">
													        ...
													        <a href="remove_message.php?message_id=<?php  echo $content[$key]['id'] ;?>" class="btn btn-danger">Yes</a>
													      </div>
													    </div>
													  </div>
													</div>
													   <a class="btn btn-danger btn-xs" href="#" data-toggle="modal" data-target="#exampleModalCenter<?php  echo $content[$key]['id'] ;?>">Remove</a>
														</td>
												</tr>
