...
if($admin->isLoggedIn()){
	$uni_code = Input::get('uni_code');
       ...
       $summary  = escape($_POST['summary']);
        ...
        $admin->update_all_ship('summary', 'uni_code', $uni_code, array(
				'reference_no' => $ref,
				'Issued_date' => $issued_date,
				'summary' => $summary
			));
        
           Session::flash('summary_add', ' Summary is Successfully Saved');
           Redirect::to('admin_summary.php?uni_code='.$uni_code);
								...
								<form action="" method="post">
									<div class="container">
										<div class="text-center"><br>
											...
											<h2 style="color:#0D8C6E">ADD SUMMARY</h2>
											<p style="color:#0D8C6E">Add your ship summary with a Ref number and Issued Date</p>
											<!-- <a href="view-summary.php?uni_code=<?php  //echo $uni_code;?>">View Summary</a> -->
										</div>
										<hr>
										<?php   
			                             $data = $admin->getData_main_cata('summary', 'uni_code', $uni_code);
