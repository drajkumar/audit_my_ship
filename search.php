            ...
            $validation =  $validate->check($_POST, array(
               'search' => array(
                ...
                if($validation->passed()){
                	...
                	$data = $user->search_result('shipall', 'shipname', Input::get('search'));   
		...
		<div class="page-container">
			...
			<div class="sidebar-menu">
				<div class="sidebar-header">
					<div class="logo">
						<a href="index.html"><img src="assets/img/sdd.png" alt="logo"></a>
					</div>
				</div>
				<div class="main-menu">
					<div class="menu-inner">
						<nav>
							<ul class="metismenu" id="menu">
								...
								<li>
									<a href="profile.php" aria-expanded="true"><i class="fa fa-ship" area="hiddden"></i><span>Profile</span></a>
						...
						<div class="col-md-6 col-sm-8 clearfix">
							...
							<div class="search-box pull-left">
								<form action="search.php" method="post">
									<input type="text" name="search" placeholder="Search Your Ship..." value="<?php echo Input::get('search'); ?>" required>
							...
							<div class="col-lg-3 col-md-6 mt-5">
								<div class="card card-bordered">
									...
									<div class="card-body">
										...
										<a href="user-summary.php?uni_code=<?php echo $data[$key]['ship_unicode'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></a>
									</div>
								</div>
							</div>
